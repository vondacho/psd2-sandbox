...
| Model | File | Grammar |
|---|---|---|
| Event storm of the PSU journey (software-design level; lanes per party, one column per moment) | [`eventstorming/obi-psu-account-list-journey.eventstorm`](eventstorming/obi-psu-account-list-journey.eventstorm) | `.eventstorm`, doc-es.obya.ch/dsl |
| Event storm of the payment journey, the backbone of the payment story map | [`eventstorming/obi-psu-payment-journey.eventstorm`](eventstorming/obi-psu-payment-journey.eventstorm) | `.eventstorm`, doc-es.obya.ch/dsl |
| Story map whose backbone is that event storm: one activity per phase between pivotal events, one step per timeline column, stories sliced into deliveries | [`storymap/obi_psu-account-list-journey.storymap`](storymap/obi_psu-account-list-journey.storymap) | `.storymap`, doc-sm.obya.ch/dsl |
| Story map of the Bank's payment services, backbone the payment event storm (increments 4 and 5) | [`storymap/obi-psu-payment-journey.storymap`](storymap/obi-psu-payment-journey.storymap) | `.storymap`, doc-sm.obya.ch/dsl |
| Story map of what the interface owes every TPP whatever the service (increments 3 and 7) | [`storymap/obi_aspsp-interface-conformance.storymap`](storymap/obi_aspsp-interface-conformance.storymap) | `.storymap`, doc-sm.obya.ch/dsl |
...
| Context map: domains, subdomains, bounded contexts and their relationships | [`domain/psd2-access-to-account.ddd`](domain/psd2-access-to-account/psd2-access-to-account.ddd) | `.ddd`, ba-cm.obya.ch/dsl |
| Domain models, one per bounded context: aggregates, roots, entities, values, enums, invariants | [`domain/consent-management.ddm`](domain/psd2-access-to-account/consent-management/consent-management.ddm), [`domain/account-information.ddm`](domain/psd2-access-to-account/account-information/account-information.ddm), [`domain/customer-identity-and-sca.ddm`](domain/psd2-access-to-account/customer-identity-and-sca/customer-identity-and-sca.ddm), [`domain/token-issuance.ddm`](domain/psd2-access-to-account/token-issuance/token-issuance.ddm), [`domain/bank-connection.ddm`](domain/psd2-access-to-account/bank-connection/bank-connection.ddm), [`domain/payment-initiation.ddm`](domain/psd2-access-to-account/payment-initiation/payment-initiation.ddm), [`domain/tpp-identification.ddm`](domain/psd2-access-to-account/tpp-identification/tpp-identification.ddm) | `.ddm`, ba-cm.obya.ch/dsl#ddm |
| C4 model in LikeC4: notation, model (people, systems, containers, components, relationships) and views (landscape, one per system, CIAM components, payment initiation, and the seven journey sequences as dynamic views) | [`likec4/specs.c4`](likec4/specs.c4), [`likec4/model.c4`](likec4/model.c4), [`likec4/views.c4`](likec4/views.c4) | LikeC4 DSL, likec4.dev/dsl |
